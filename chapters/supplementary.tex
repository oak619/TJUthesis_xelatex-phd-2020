...
\begin{figure*}[htp]
    ...
    \centering
    \subfigure[Basketball]{\includegraphics[width=0.31\linewidth,height=0.23\linewidth]{Figure2a1.pdf}
    ...
    \centering
    \subfigure[David3]{\includegraphics[width=0.31\linewidth,height=0.23\linewidth]{Figure2b1.pdf}
    ...
    \centering
    \subfigure[Football]{\includegraphics[width=0.31\linewidth,height=0.23\linewidth]{Figure2c1.pdf}
    ...
    \centering
    \subfigure[Jogging]{\includegraphics[width=0.31\linewidth,height=0.23\linewidth]{Figure2d1.pdf}
    ...
    \centering
    \subfigure[Liquor]{\includegraphics[width=0.31\linewidth,height=0.23\linewidth]{Figure2e1.pdf}
